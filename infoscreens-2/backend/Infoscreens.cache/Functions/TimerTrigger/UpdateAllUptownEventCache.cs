...
{
    public class UpdateAllUptownEventCache
    {
        #region Constructor / Dependency Injection

        readonly ILogger<UpdateAllUptownEventCache> _logger;

        public UpdateAllUptownEventCache(ILogger<UpdateAllUptownEventCache> logger)
        {
            _logger = logger;
        }
        ...
        const string FUNCTION_NAME = "UpdateAllUptownEventCache";
