...
{
    public class GetNews : BaseApiClass
    {
        ...
        const string FUNCTION_NAME = "GetNews";
        [Function(FUNCTION_NAME)]
        public async Task<HttpResponseData> RunAsync([HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "v1/news/{tenantCode}/{newsId}")] HttpRequestData req, string tenantCode, int newsId)
        {
            try
            {
