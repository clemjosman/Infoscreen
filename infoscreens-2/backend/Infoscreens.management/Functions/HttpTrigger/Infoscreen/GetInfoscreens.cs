...
namespace Infoscreens.Management.Functions
{
    ...
    public class GetInfoscreens : BaseApiClass
    {
        #region Constructor / Dependency Injection

        public GetInfoscreens(
        ...
        const string FUNCTION_NAME = "GetInfoscreens";
        [Function(FUNCTION_NAME)]
        public async Task<HttpResponseData> RunAsync([HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "v1/infoscreens/{tenantCode}")] HttpRequestData req, string tenantCode)
        {
            try
            {
