...
{
    public class UpdateSelectedLanguage_App : BaseApiClass
    {
        #region Constructor / Dependency Injection

        private readonly IUserRepository _userRepository;

        public UpdateSelectedLanguage_App(
        ...
        const string FUNCTION_NAME = "UpdateSelectedLanguage_App";
        [Function(FUNCTION_NAME)]
        public async Task<HttpResponseData> RunAsync([HttpTrigger(AuthorizationLevel.Anonymous, "put", Route = "v1/app/user/selectedLanguage")] HttpRequestData req)
        {
            try
            {
